      ...
      {product && (
        <div className="w-full">
          <div className="w-full aspect-[3/4] relative product-image">
            ...
            <button className="absolute top-2 z-[2] end-2 text-2xl bg-white bg-opacity-20 rounded px-2 py-1">
